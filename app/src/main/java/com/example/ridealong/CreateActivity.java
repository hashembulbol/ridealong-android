...
public class CreateActivity extends AppCompatActivity implements TabLayoutMediator.TabConfigurationStrategy {
        ...
        fabNav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (pos == 0){
                    ...
                    RetroClient.getInstance().getMyApi().createTrip(SavedSharedPreference.getProfile(CreateActivity.this).getUsername(),
                        ...
                        public void onResponse(Call<Object> call, Response<Object> response) {
                            Log.d("CreateActivity", response.toString());
                            finish();
                        }

                        @Override
                        public void onFailure(Call<Object> call, Throwable t) {
                            Log.d("CreateActivity", t.getMessage());

                        }
                    });

                    Log.d("CreateActivity", current.toString());
                }
            }
        });

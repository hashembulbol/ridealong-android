...
public class DriverOldTripsAdapter extends RecyclerView.Adapter<DriverOldTripsAdapter.TripsViewHolder> {
    ...
    public DriverOldTripsAdapter(Context context, List<Trip> items, PathViewModel model){
    ...
    @NonNull
    @Override
    public DriverOldTripsAdapter.TripsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.rv_driveroldtrip_item, parent, false);

        return new DriverOldTripsAdapter.TripsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DriverOldTripsAdapter.TripsViewHolder holder, int position) {
        ...
        holder.tvPrice.setText(currentTrip.getRevenue());
    ...
    public static class TripsViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageButton btnShow;
        TextView tvRiders, tvStatus, tvDate, tvPrice;

        public TripsViewHolder(@NonNull View itemView) {
            super(itemView);

            tvRiders = itemView.findViewById(R.id.tvDrvRidersOld);
            tvStatus = itemView.findViewById(R.id.tvStatusOldDrvTrip);
            btnShow = itemView.findViewById(R.id.btnDrvShowTripOldTrip);
            tvPrice = itemView.findViewById(R.id.tvDrvOldPrice);
            tvDate = itemView.findViewById(R.id.tvDrvOldDate);

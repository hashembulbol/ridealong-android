...
public class PassengerOldTripAdapter extends RecyclerView.Adapter<PassengerOldTripAdapter.TripsViewHolder> {
    ...
    public PassengerOldTripAdapter(Context context, List<Trip> items, PathViewModel model){
    ...
    @NonNull
    @Override
    public PassengerOldTripAdapter.TripsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.rv_oldtrip_item, parent, false);

        return new PassengerOldTripAdapter.TripsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PassengerOldTripAdapter.TripsViewHolder holder, int position) {
        ...
        //holder.tvDate.setText(currentTrip.getDatetime());
        holder.tvStatus.setText(currentTrip.getStatus().getName());

        for (Ride r: currentTrip.getRides()){
            if (r.getUser() == SavedSharedPreference.getProfile(context).getId())
                holder.tvPrice.setText(r.getCost());
        }
    ...
    public static class TripsViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageButton btnShow;
        TextView tvRiders, tvStatus, tvDate, tvPrice, tvName;

        public TripsViewHolder(@NonNull View itemView) {
            super(itemView);

            tvRiders = itemView.findViewById(R.id.tvPassOldTripRiders);
            tvStatus = itemView.findViewById(R.id.tvStatusOldPassTrip);
            btnShow = itemView.findViewById(R.id.btnPassOldTripShow);
            tvPrice = itemView.findViewById(R.id.tvPassOldTripPrice);
            tvDate = itemView.findViewById(R.id.tvPassOldTripDate);
            tvName = itemView.findViewById(R.id.tvPassOldTripName);
